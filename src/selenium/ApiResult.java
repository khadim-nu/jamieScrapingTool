...
public class ApiResult
{
	...
	public static ApiResult Extract(String data)
	{
		...
		for(int i = 0;i < count;i++)
		{
			...
			if (name == "TaskId") ret.TaskId = val;
			else if (name == "Value") ret.DecodedValue = val;
			else if (name == "Error") ret.Error = val;
			else if (name == "Left") ret.LeftCredits = val;
		}

		if (ret.TaskId != "-1" || ret.LeftCredits != "-1") ret.IsCallOk = true;
		return ret;
	}
}
